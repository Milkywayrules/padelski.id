...
/**
 * Host-local dev (doppler run on machine): infra + public URLs in Doppler dev_personal.
 * Deploy configs ignore these — compose wires them at deploy (Coolify SERVICE_URL_*).
 */
export const DOPPLER_LOCAL_HOST_KEYS = [
  "DB_URL",
  "REDIS_URL",
  "API_CORS_ORIGIN",
  "BETTER_AUTH_URL",
...
export const COMPOSE_WIRED_AT_DEPLOY = [
  "DB_URL",
  "REDIS_URL",
  "API_CORS_ORIGIN",
  "BETTER_AUTH_URL",
